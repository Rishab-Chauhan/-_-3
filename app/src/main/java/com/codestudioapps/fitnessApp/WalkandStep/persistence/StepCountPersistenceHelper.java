...
package com.codestudioapps.fitnessApp.WalkandStep.persistence;
...
public class StepCountPersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_STEPS_SAVED = "com.codestudioapps.fitnessApp.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "com.codestudioapps.fitnessApp.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "com.codestudioapps.fitnessApp.STEPS_INSERTED";
